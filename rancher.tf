...
resource "aws_alb_target_group" "rancher-tg" {
  ...
  port = 80
  protocol = "HTTP"
  vpc_id = "vpc-0cd70a9d08bf44455" // Modify to your vpc
...
resource "aws_lb" "rancher-alb" {
  ...
  subnets = ["subnet-071492cbe15f20420", "subnet-0545a33a6805b8b58", "subnet-0bd1b403f5af90c74"] // The subnet(s) you will run Rancher server
...
data "aws_acm_certificate" "cert" {
  ...
  statuses = [ "ISSUED" ]
  types = var.certificate_issue_type
